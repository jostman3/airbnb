...
SELECT listings.property_type, COUNT(*), MAX(reviews.date_reviewed) FROM listings INNER JOIN reviews ON listings.ID = reviews.listing_id  GROUP BY listings.property_type;
